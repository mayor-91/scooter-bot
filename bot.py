...
- Диск колеса переднего (рёбра/отверстия в диске, чёрная вилка — металл, может облупляться краска)
- Диск колеса заднего / Мотор (сплошной диск без рёбер, другая вилка — металл, может облупляться краска)
- Передняя вилка (чёрная, соединяет переднее колесо со стойкой — металл, может облупляться краска)
- Тормозной барабан передний (деформация, механическая поломка — НЕ путать с диском)
- Тормозной диск/механизм задний
...
- Верхняя часть стойки (выше трекера до руля, металл — НЕ облупляется, только: Царапины, Трещина/скол, Вмятина/деформация)
- Средняя часть стойки (зона трекера ±5-7 см, металл — НЕ облупляется, только: Царапины, Трещина/скол, Вмятина/деформация)
- Нижняя часть стойки (ниже трекера до стакана, металл — НЕ облупляется, только: Царапины, Трещина/скол, Вмятина/деформация)
- Трекер (пластиковый блок с логотипом JET на стойке — возможные дефекты: Царапины, Трещина/скол, Вмятина/деформация, Отсутствие детали)
- Дека (платформа)
- Заднее крыло (пластик — только: Царапины, Царапины с ржавчиной, Полосы краски от столкновения, Трещина/скол — вмятины НЕ считаем)
- Переднее крыло
- Фонарь передний
- Фонарь задний
- Номерная табличка
...
ТИПЫ дефектов:
- Облупившаяся краска (только на металле: диски колёс, мотор — если есть, царапины НЕ указывай)
- Царапины
- Царапины с ржавчиной (царапина где видна ржавчина — НЕ указывай отдельно Царапины и Ржавчину)
- Ржавчина (без царапин, просто ржавое пятно)
- Трещина/скол
- Вмятина/деформация
- Механическая поломка
- Отсутствие детали (номера, крышки и т.д.)
- Номер нечитаем (табличка есть, но номер стёрт или повреждён)
- Полосы краски от столкновения (синие/цветные полосы на крыле от удара о другой самокат)

ВАЖНЫЕ ПРАВИЛА:
- Загрязнение/грязь НЕ считается дефектом — никогда не указывай его
- Если есть Облупившаяся краска — НЕ указывай Царапины для того же места
- Облупившаяся краска — только если реально видны отслоения краски, не путай с царапинами
- Если царапина с ржавчиной — пиши "Царапины с ржавчиной", не разделяй на два дефекта
- Тормозной диск: смотри на деформацию и механические повреждения (ржавчина на нём НЕ считается)
- Ржавчина встречается только на раме самоката (дека, крылья, стойка)
- Отсутствие номерной таблички = дефект "Отсутствие детали"
- Табличка есть но номер стёрт/царапан/нечитаем = дефект "Номер нечитаем"
- На номерной табличке НЕ бывает "Облупившаяся краска"
